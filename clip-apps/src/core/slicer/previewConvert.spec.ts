...
import { convertWidgetSlicesToLayers, lineToPath, polyToPath } from './previewConvert'
...
describe('slicer.previewConvert', () => {
  ...
  it('maps thin_wall traces to perimeter segments', () => {
    const layers = convertWidgetSlicesToLayers([
      {
        z: 0.2,
        tops: [
  ...
  it('maps slice-level groups/solids/bridges/flats and top.solids/bridges', () => {
    const layers = convertWidgetSlicesToLayers([
      {
        z: 0.2,
        tops: [
  ...
  it('maps slice.lines to travel (p1/p2 and start/end)', () => {
    const layers = convertWidgetSlicesToLayers([
      {
        z: 0.2,
        tops: [
  ...
  it('maps slice.lines as flat Point pairs to travel', () => {
    const layers = convertWidgetSlicesToLayers([
      {
        z: 0.2,
        tops: [
  ...
  it('maps fill_off and gaps polygons to infill', () => {
    const layers = convertWidgetSlicesToLayers([
      {
        z: 0.2,
        tops: [
